...
const WhatIDo = () => {
  ...
  return (
    <div className="whatIDO ">
      ...
      <div className="what-box margin-top:40px">
        <div className="what-box-in ">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Creating Modern & Scalable User Interfaces</h4>
              <p>
                Building fast, responsive, and visually engaging web interfaces
                using modern frontend technologies. I focus on clean
